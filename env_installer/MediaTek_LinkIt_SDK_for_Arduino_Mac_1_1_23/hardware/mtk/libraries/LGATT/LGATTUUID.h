...
public:
    ...
    // Parameters
    //    uuid :  The 16-bit UUID in Bluetooth specifications, for example, 0x1810 for blood Pressure Service. Please see
    ...
    // Parameters
    //    uuid :  The UUID string in canonical form, for example, 9D6EB1F1-F16D-5B84-5640-E5FF491FA020.         
    ...
    // Parameters
    //    uuid :  The 16-bit UUID in Bluetooth specifications, for example, 0x1810 for blood Pressure Service. Please see https://www.bluetooth.org/en-us/specification/assigned-numbers
